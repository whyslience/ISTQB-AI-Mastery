...
## 1.1 What is Testing? / 1.1 Kiểm thử là gì?
...
### 1.1.1 Test Objectives / 1.1.1 Mục tiêu Kiểm thử
...
### 1.1.2 Testing and Debugging / 1.1.2 Kiểm thử và Gỡ lỗi
...
## 1.2 Why is Testing Necessary? / 1.2 Tại sao cần Kiểm thử?
...
### 1.2.1 Testing’s Contributions to Success / 1.2.1 Đóng góp của Kiểm thử vào Thành công
...
### 1.2.2 Testing and Quality Assurance (QA) / 1.2.2 Kiểm thử và Đảm bảo Chất lượng (QA)
...
### 1.2.3 Errors, Defects, Failures, and Root Causes / 1.2.3 Sai lầm, Khiếm khuyết, Lỗi và Nguyên nhân gốc rễ
...
## 1.3 Testing Principles / 1.3 Các Nguyên tắc Kiểm thử
...
## 1.4 Test Activities, Testware and Test Roles / 1.4 Các hoạt động kiểm thử, Tài liệu kiểm thử và Vai trò kiểm thử
...
### 1.4.1 Test Activities and Tasks / 1.4.1 Các hoạt động và nhiệm vụ kiểm thử
...
### 1.4.2 Test Process in Context / 1.4.2 Quy trình kiểm thử trong ngữ cảnh
...
### 1.4.3 Testware / 1.4.3 Tài liệu kiểm thử (Testware)
...
### 1.4.4 Traceability between the Test Basis and Testware / 1.4.4 Truy xuất nguồn gốc giữa Cơ sở kiểm thử và Tài liệu kiểm thử
...
### 1.4.5 Roles in Testing / 1.4.5 Các vai trò trong kiểm thử
...
## 1.5 Essential Skills and Good Practices in Testing / 1.5 Kỹ năng thiết yếu và Thực hành tốt trong Kiểm thử

### 1.5.1 Generic Skills Required for Testing / 1.5.1 Các kỹ năng chung cần thiết cho kiểm thử
...
### 1.5.2 Whole Team Approach / 1.5.2 Cách tiếp cận toàn đội (Whole Team Approach)
...
### 1.5.3 Independence of Testing / 1.5.3 Sự độc lập của kiểm thử
