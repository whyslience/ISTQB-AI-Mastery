...
> **ISTQB CTFL v4.0.1** · **390 minutes** / **390 phút** giảng dạy tối thiểu (theo giáo trình chính thức).
...
### 4.1 Test Techniques Overview / Tổng quan Kỹ thuật Kiểm thử

* **FL-4.1.1 (K2)** Distinguish black-box test techniques, white-box test techniques and experience-based test techniques / **FL-4.1.1 (K2)** Phân biệt kỹ thuật hộp đen, hộp trắng và dựa trên kinh nghiệm

### 4.2 Black-box Test Techniques / Kỹ thuật Hộp đen

* **FL-4.2.1 (K3)** Use equivalence partitioning to derive test cases / **FL-4.2.1 (K3)** Dùng phân vùng tương đương để xây dựng ca kiểm thử
* **FL-4.2.2 (K3)** Use boundary value analysis to derive test cases / **FL-4.2.2 (K3)** Dùng phân tích giá trị biên để xây dựng ca kiểm thử
* **FL-4.2.3 (K3)** Use decision table testing to derive test cases / **FL-4.2.3 (K3)** Dùng bảng quyết định để xây dựng ca kiểm thử
* **FL-4.2.4 (K3)** Use state transition testing to derive test cases / **FL-4.2.4 (K3)** Dùng kiểm thử chuyển trạng thái để xây dựng ca kiểm thử

### 4.3 White-box Test Techniques / Kỹ thuật Hộp trắng

* **FL-4.3.1 (K2)** Explain statement testing / **FL-4.3.1 (K2)** Giải thích kiểm thử câu lệnh
* **FL-4.3.2 (K2)** Explain branch testing / **FL-4.3.2 (K2)** Giải thích kiểm thử nhánh
* **FL-4.3.3 (K2)** Explain the value of white-box testing / **FL-4.3.3 (K2)** Giải thích giá trị của kiểm thử hộp trắng

### 4.4 Experience-based Test Techniques / Kỹ thuật Dựa trên Kinh nghiệm

* **FL-4.4.1 (K2)** Explain error guessing / **FL-4.4.1 (K2)** Giải thích đoán lỗi
* **FL-4.4.2 (K2)** Explain exploratory testing / **FL-4.4.2 (K2)** Giải thích kiểm thử khám phá
* **FL-4.4.3 (K2)** Explain checklist-based testing / **FL-4.4.3 (K2)** Giải thích kiểm thử dựa trên checklist

### 4.5 Collaboration-based Test Approaches / Tiếp cận Kiểm thử Hợp tác

* **FL-4.5.1 (K2)** Explain how to write user stories in collaboration with developers and business representatives / **FL-4.5.1 (K2)** Giải thích cách viết user story cùng lập trình viên và đại diện nghiệp vụ
* **FL-4.5.2 (K2)** Classify the different options for writing acceptance criteria / **FL-4.5.2 (K2)** Phân loại các cách viết tiêu chí chấp nhận
* **FL-4.5.3 (K3)** Use acceptance test-driven development (ATDD) to derive test cases / **FL-4.5.3 (K3)** Dùng ATDD để xây dựng ca kiểm thử

---

## 4.1 Test Techniques Overview / Tổng quan về các Kỹ thuật Kiểm thử
...
### 4.1.1 Categories of Test Techniques / Các Nhóm Kỹ thuật Kiểm thử
...
## 4.2 Black-box Test Techniques / Các Kỹ thuật Kiểm thử Hộp đen
...
### 4.2.3 Decision Table Testing / Kiểm thử Bảng Quyết định
...
### 4.2.4 State Transition Testing / Kiểm thử Chuyển đổi Trạng thái
...
## 4.3 White-box Test Techniques / Các Kỹ thuật Kiểm thử Hộp trắng

### 4.3.1 Statement Testing and Statement Coverage / Kiểm thử Câu lệnh và Độ bao phủ Câu lệnh
...
### 4.3.2 Branch Testing and Branch Coverage / Kiểm thử Nhánh và Độ bao phủ Nhánh
...
### 4.3.3 Value of White-box Testing / Giá trị của Kiểm thử Hộp trắng
...
## 4.4 Experience-based Test Techniques / Các Kỹ thuật Kiểm thử dựa trên Kinh nghiệm

### 4.4.1 Error Guessing / Đoán Lỗi (Error Guessing)
...
### 4.4.2 Exploratory Testing / Kiểm thử Khám phá (Exploratory Testing)
...
### 4.5.1 Collaborative User Story Writing / Viết User Story có sự Hợp tác
...
### 4.5.3 Acceptance Test-Driven Development (ATDD) / Phát triển Hướng Kiểm thử Chấp nhận (ATDD)
