...
> **ISTQB CTFL v4.0.1** · **20 minutes** / **20 phút** giảng dạy tối thiểu (theo giáo trình chính thức).
...
## Learning Objectives for Chapter 6 / Mục tiêu học tập Chương 6

### 6.1 Tool Support for Testing / Hỗ trợ Công cụ cho Kiểm thử

* **FL-6.1.1 (K2)** Explain how different types of test tools support testing / **FL-6.1.1 (K2)** Giải thích các loại công cụ kiểm thử hỗ trợ kiểm thử thế nào

### 6.2 Benefits and Risks of Test Automation / Lợi ích và Rủi ro Tự động hóa

* **FL-6.2.1 (K1)** Recall the benefits and risks of test automation / **FL-6.2.1 (K1)** Ghi nhớ lợi ích và rủi ro của tự động hóa kiểm thử

---

## 6.1 Tool Support for Testing / Hỗ trợ của Công cụ đối với Kiểm thử
...
### 6.1.1 Categories of Test Tools / Các Nhóm Công cụ Kiểm thử
...
## 6.2 Benefits and Risks of Test Automation / Lợi ích và Rủi ro của Tự động hóa Kiểm thử
...
### 6.2.1 Potential Benefits of Test Automation / Lợi ích Tiềm năng của Tự động hóa Kiểm thử
...
### 6.2.2 Potential Risks of Test Automation / Rủi ro Tiềm năng của Tự động hóa Kiểm thử
